...
public class GuavaOrderingTest {
    ...
    public void testOrdering() throws Exception {
        ...
        Ordering<OrderBean> ordering = Ordering.natural().nullsLast().onResultOf(new Function<OrderBean, Comparable>() {
            @Override
            public Comparable apply(OrderBean orderBean) {
                return orderBean.getFinishTime();
            }
        }).compound((o1, o2) -> {
