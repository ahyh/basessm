...
public class EncrypInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Object param = args[1];
        //拿到入参的Class，非对象类型的话不加密
        if (param == null || param instanceof Integer || param instanceof String || param instanceof Double || param instanceof Float || param instanceof Character || param instanceof Long) {
        ...
        if (returnValue == null || returnValue instanceof Integer
                || returnValue instanceof String || returnValue instanceof Double
                || returnValue instanceof Float || returnValue instanceof Character
